defmodule Exchange.Engine do
    ...
    def match(order) do
        ...
        {:ok, outputs} = Exchange.Engine.Native.match_order(order, orderbook, orderbook_inverse)
        ...
        Exchange.Orders.update_all(outputs.modified_orders, outputs.order)
        ...
        if (lt > 0 or (lo == 0 or lo1 == 0) ) or (lt > 0 and (lo > 0 or lo1 > 0) ) do
            ...
            Exchange.Trigger.hit(order.market_id, order.price, p)
        end
